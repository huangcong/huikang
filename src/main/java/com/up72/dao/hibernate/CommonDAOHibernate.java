...
public class CommonDAOHibernate extends HibernateDaoSupport {
	...
	public Long findcount(Class clz, String param,
		...
		if (param != null && !"".equals(param)) {
			hsql.append("select " + param + " from " + clz.getSimpleName()
					+ " where 1=1");
		} else {
			hsql.append("select count(id) from " + clz.getSimpleName()
					+ " where 1=1");
		}
		...
		return findcount(hsql.toString(), values.toArray());
	}
	...
	public List findList(String hql, HashMap<String, Object> params,
		...
		return findList(hsql.toString(), values.toArray(), dataNum, orderMap,
				isQueryCache, cacheRegion);
	}
	...
	public QueryResult findPage(String hql, HashMap<String, Object> params,
		...
		QueryResult result = findPage(hsql.toString(), values.toArray(),
