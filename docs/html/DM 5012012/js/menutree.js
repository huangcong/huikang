...
$(document).ready(function(){
   ...
   $(".l2").toggle(function(){
     $(this).next(".sslist").animate({height: 'toggle', opacity: 'toggle'}, "fast");
   },function(){
                 $(this).next(".sslist").animate({height: 'toggle', opacity: 'toggle'}, "fast");
   });
   ...
   $(".close").toggle(function(){
        ...
        $(".slist").animate({height: 'toggle', opacity: 'toggle'}, "fast");  
        $(".sslist").animate({height: 'toggle', opacity: 'toggle'}, "fast");  
        });  
});